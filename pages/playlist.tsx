...
const Playlist: NextPage<PlaylistType> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col w-3/4 tabPort:w-full sm:w-full mx-auto px-6 py-10">
      <h1 className="text-5xl font-semibold mb-5 opacity-50">Playlist</h1>
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  try {
    const searchRes = await fetch(
      `https://youtube-v31.p.rapidapi.com/playlistItems?playlistId=${query.playlistId}&part=snippet%2Cid&maxResults=50`,
      {
        method: "GET",
        headers: {
...
export default authProtected(Playlist);
