...
export default class ModalVideo extends React.Component {
  ...
  componentDidMount() {
    ...
    window.addEventListener(
      "resize",
      this.resizeModalVideoWhenHeightGreaterThanWindowHeight.bind(this)
    );
    this.setState({
  ...
  resizeModalVideoWhenHeightGreaterThanWindowHeight() {
    ...
    this.timeout = setTimeout(() => {
      const width = this.getWidthFulfillAspectRatio(
        this.props.ratio,
        window.innerHeight,
        window.innerWidth
      );
          ...
          return (
            ...
            >
              <div className={this.props.classNames.modalVideoBody}>
                <div
                  className={this.props.classNames.modalVideoInner}
